...
//Sol:
var isName:string = "Abdullah Shahid";
...
//Sol:
var myName:string = "Abdullah Shahid";
...
//Sol
let friendsName:string [] = ["Abdullah" , "Zaid" , "Ans" , "Ibrahim" , "Ayyan"];
...
//Sol
let my_friends:string [] = ["Abdullah" , "Zaid" , "Ans" , "Ibrahim" , "Ayyan"];
...
//Sol:
let transport:string[] = ["Bike" , "Car" , "Ship" , "Plane"];
...
let places:string [] = ["Rome, Italy" , "Hunza, Pakistan" , "London, England" ,"Angkor Wat, Cambodia" , "Bali , Indonesia"];
console.log(places);
...
let guests:string [] = ["Abdullah" , "Zaid" ,"Ahsan"];
...
//Sol
let countries:string[] = ["England" , "Canada" , "America" , "Italy" ,"Russia"];
for (let i = 0 ; i <countries.length ; i++)
{
    console.log(`${countries[i]}`);
}

//Assing 21: They think of something you could store in a TypeScript Object. 
...
let cities:string[] = ["London" , "Jakarta" , "Washington" , "Islamabad" , "Colombo"];
...
let RAM:string = "Reading Access Memory";
...
let user_Name:string [] = ["admin" , "Abdullah" , "Zaid" , "Ahmed" ,"Ans"];
...
let current_users: string[] = ["abdullah", "ans", "zaid", "ahsan", "ahmed"];
let new_users: string[] = ["Abdullah", "zAID", "emma", "Amir", "FARAZ"];
for(var i=0;i<new_users.length ;++i){
    console.log(`Checking ${new_users[i]}`)
}
    
// Step 1: Make a list of current users and new users
const currentUsers:string [] = ["Abdullah" , "Naeem" , "Zaid" , "Maqsood" , "Fahad"];
const newUser:string [ ] = ["ABdullah" , "Ans" , "Amir" , "zaid" , "Awais"] 
...
let pizza:string [] = ["Margherita" , "marinara" ,"pepperoni"];
pizza.forEach((data)=>{
...
function make_shirt (shirt:string) {
    console.log(shirt)
    return make_shirt;
}
...
function describe_city (country:string[]) {
    console.log(country)
    return describe_city;
}
describe_city(["Lahore, Pakistan" , "London, England" , "Washington, USA"])

//Assign 40: Album: Write a function called make_album() that builds a Object describing a music album. 
...
type make_album = {
        name:string; album:string; track:string;
}
...
function foodOrder (food:string[]) {
    food.forEach((foods) =>
    {
    ...
    function foodsOrder (food:string[]) {
        // food.forEach((foods) =>
        // {
        //     console.log(`I am happy to eat ${foods}`)
        // })
        ...
        //Assign 45: Cars: Write a function that stores information about a car in a Object. 
...
type Car = {
  ...
  function createCar(manufacturer: string, model: string, ...extras: any[]): Car {
    const car: Car = {
